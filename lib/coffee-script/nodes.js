...
(function() {
  ...
  exports.Class = Class = (function(superClass1) {
    ...
    Class.prototype.compileNode = function(o) {
      var args, argumentsNode, fragments, jumpNode, lname, name, ref3, superClass;
      ...
      console.log(this.body);
      fragments = [this.makeCode('class ')];
      fragments = fragments.concat(lname.compileToFragments(o));
      fragments = fragments.concat(this.body.compileToFragments(o));
      return fragments;
    };
